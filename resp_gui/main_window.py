...
import os
import qdarktheme
from PySide6.QtWidgets import QApplication, QMainWindow, QMenuBar, QTabWidget, QWidget, QVBoxLayout, QTableWidget, QMessageBox, QFileDialog
...
class MainWindow(QMainWindow):
    ...
    def reset_raw_data_table(self):
        ...
        self.raw_data_table.setHorizontalHeaderLabels(["ID / chain", "Name", "Sequence",
            "Errors / issues", "Input file", "Cluster"])
