...
namespace SequenceUtilities{
    ...
    /// @brief Trims a sequence using the corresponding alignment so that c- or n-terminal gaps
    ///        are removed.
    ...
    ///                  This tuple is generated by classes in NumberingTools when calling
    ///                  analyze_seq. Must be of the same size() as sequences.
    /// @param trimmed_alignment A vector in which the trimmed alignment output will be stored.
    ///                          Should be empty initially.
    /// @param exstart An int in which the first non-trimmed position will be stored.
